...
[![Build Status](https://dev.azure.com/andreaspersson/node-express-demo/_apis/build/status/PerryPerro.node-express-azure?branchName=master)](https://dev.azure.com/andreaspersson/node-express-demo/_build/latest?definitionId=2&branchName=master)

## Running and Testing Locally:

You can use these commandssos to install, tessst, and run the app locally. (Not Required)
